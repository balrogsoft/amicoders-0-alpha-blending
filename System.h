...
UBYTE NameString[]="InputHandleIntro";


UWORD chip sprdata[16+(200<<3)] = {0x2C40,0, 0, 0, 0xf400, 0, 0, 0};// ;VSTART, HSTART, VSTOP};//;End of sprite data}
...
int installVBInterrupt(void)
{
   if(vbint = AllocMem(sizeof(struct Interrupt), MEMF_PUBLIC|MEMF_CLEAR)) {
      ...
      vbint->is_Node.ln_Name = "VB-Intro";
